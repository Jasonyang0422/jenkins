...
do
    ...
    if [[ $refname = "refs/heads/master" ]] ; then
        ...
        git archive $newrev | tar -x -C /Users/jyang/Vonage/tmp/HRChatBotTesting
        ...
        cd /Users/jyang/Vonage/HRChatBotTesting_Github       
        ...
        if [[ $rc != 0 ]] ; then
            ...
            echo "test failed on rev $newrev - push deniend. Run tests locally and confirm they pass before pushing"
            exit $rc
        fi
    fi
done
